    ...
    public class PaymentController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreatePayment(int paymentContractId, string platform = "mobile")
        {
            ...
            try
            {
                ...
                var vnp_Url = _appSettings.PaymentBaseUrl;

                var vnp_TmnCode = _appSettings.TmnCode;
                var vnp_HashSecret = _appSettings.HashSecretKey;
        ...
        public IActionResult PaymentErorr(string errorCode)
        {
            ...
            try
            {
                string filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "payment-error.html");
        ...
        public async Task<IActionResult> PaymentSuccess(string id)
        {
            ...
            try
            {
                string filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "payment-success.html");
                string htmlContent = System.IO.File.ReadAllText(filePath);
